...
app.config['SQLALCHEMY_BINDS'] = {'user':'sqlite:///user.db','vehicalregistered':'sqlite:///vehicalregistered.db'}
db = SQLAlchemy(app)
...
from vparkingmgmt.import_data.routes import blue
...
app.register_blueprint(import_data.routes.blue,url_prefix='/')